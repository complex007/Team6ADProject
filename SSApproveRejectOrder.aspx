...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h3>ApproveRejectOrdersForm</h3>
        ...
        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" DataKeyNames="purchaseordernumber" Height="185px" Width="917px" OnRowCommand="GridView2_RowCommand">
            <Columns>
    ...
    <asp:GridView ID="GridView1" runat="server">
                ...
                <td style="width: 124px">
                    <asp:TextBox ID="TextBox1" runat="server" Height="70px" Width="271px" Style="margin-top: 29px" AutoPostBack="true"></asp:TextBox>
                </td>
                <td></td>
            </tr>
        </table>
